...
public class PrintShortestCommonSubsequence {
	// same as LongestCommonSubstringprint but we will include character if they are not same also
	// we will include them if any one of them reache 0;
	public static void main(String[] args) {
		String s1 = "HELLO"; //AGGTAB
	    String s2 = "GEEK"; //GXTXAYB
