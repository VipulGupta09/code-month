...
public class FindMissingDuplicate {
	...
	public static void findMissingAndDuplicate(int [] arr) {
		...
		for( i=0;i<arr.length;i++) {
			if(arr[i]!=i+1) {
				System.out.println("duplicate "+arr[i] +" "+ "missing "+(i+1));
			}
		}
	}
